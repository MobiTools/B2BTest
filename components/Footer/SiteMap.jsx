...
function Copyright() {
  return (
    <Typography
      ...
      color="textSecondary"
    >
      &copy;&nbsp; 2023. Matteale Consulting. Toate drepturile rezervate.
    </Typography>
  );
}
    ...
    <div component="footer" className={classes.footer}>
      <Grid container spacing={4}>
        ...
        />
            ...
            >
              We combine our team ingenuity with technology to drive results across your business.
            </Typography>
          </div>
          {isDesktop && <Copyright />}
        </Grid>
                    ...
                    {footer.description.map((item, index) => (
                      <li key={item}>
                        <Link
                          ...
                          variant="subtitle1"
                          underline="hover"
                          style={{ color: "white", fontSize: "16px", marginRight:0 }}
                        >
                          {item}
                        </Link>
                      </li>
