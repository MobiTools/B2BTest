  ...
  return (
    ...
    <div className="flex flex-wrap items-stretch justify-between h-full"> 
      ...
      <div className="md:relative md:w-10/12  md:left-20 fadeIn">
        <h2 className="text-firstHeader font-bold text-white mb-1" style={{lineHeight:indexLineHeight}}>
          SAP services, cloud solutions and IT infrastructure support
        </h2>
        <p className="text-white text-paragraf" >
          <span className="text-accent">Future-proof your business</span> with our top-notch services.
        </p>

        <Link href={"/contact"} passHref>
    <button style={{ height: '43px', width:"170px", marginTop:"25.6px" }} className="border-2 border-accent  text-white px-6 rounded bg-transparent hover:bg-accent hover:text-white transition duration-300">
        Contact us
    </button>
</Link>
        </div>
