  ...
  return (
    <Fragment>
      ...
      >
        ...
        >
          <div className={classes.headerContent} style={{backgroundColor: fixed && "rgba(0, 0, 0, 0.5)"}}>
            <nav className={classes.navMenu} style={{backgroundColor: fixed && "rgba(0, 0, 0, 0.5)"}}>
            <div className={classes.logo} style={{paddingLeft : isMobile && 10}}>
