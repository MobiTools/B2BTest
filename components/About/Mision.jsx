            ...
            <Grid item sm={6} order={{ xs: 2, sm: 1, md:1 }}>
              <Box px={{ sm: 5 }}>
                <div className={classes.text}>
                  ...
                  >
                    {
                      "Delivering exceptional SAP consultancy services by understanding our clients’ unique needs, providing expert guidance, and implementing tailored solutions that drive growth, efficiency, and profitability."
                    }
                  </h2>
                </div>
              </Box>
