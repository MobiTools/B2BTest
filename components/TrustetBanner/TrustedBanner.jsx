...
const images = ['/partners/unity solutions.png', '/kyndryl-logo-3.png', "/partners/SAP_Partner_R.png", "/partners/Alten-logo.png"];
...
const TrustedBanner = () => {
  ...
  return (
    ...
    <Grid container spacing={2} ref={domRef} className={`slideUpFadeIn ${isVisible ? 'animated' : ''}`}>
          <Grid item xs={12}>
            <h2
              style={{
                color: "white",
