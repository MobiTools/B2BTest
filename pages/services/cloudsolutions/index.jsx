...
import { CloudSolutionsData, constantServices } from "../../../data/servicesData";
...
function CloudSolutions(props) {
  ...
  return (
    <Fragment>
        ...
        <meta property="og:title" content="Cloud Solutions | Cloud Migration | Cloud Security" />
        <meta
              ...
              <Container>
                <Grid container spacing={4}>
                  ...
                  <Grid item md={4} xs={12} style={{ paddingTop: 0 }}>
                    <Sidebar services={props.services} constantServices={constantServices}/>
                  </Grid>
                </Grid>
              </Container>
            </Box>
